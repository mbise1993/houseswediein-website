...
export const LYRICS = (
  <>
    Clutching this wooden box
    <br />
    That keeps my fondest memories
    <br />
    From my exhausted soul
    <br />
    <br />
    Pictures curled into ash
    <br />
    As I burned it all away
    <br />
    Confiding in how much I despise
    <br />
    ...
    Of loneliness
    <br />
    Coping with the pain the only way
    <br />
    That I know how
    <br />
    <br />
    ...
    <br />
    <br />
    No escaping the fear
    <br />
    Trembling under portraits of you
    <br />
    No running from our mistakes
    <br />
    Shivering in the cold winds of change
    <br />
    <br />
    The heavens will know my name
    <br />
    And the skies will hear my cries
    <br />

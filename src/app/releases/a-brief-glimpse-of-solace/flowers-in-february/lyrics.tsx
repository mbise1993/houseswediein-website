...
export const LYRICS = (
  <>
    ...
    <br />
    <br />
    Broken fists smash through the floor
    <br />
    In hopes that the earth would open up
    <br />
    ...
    <br />
    <br />
    It's the tightness that builds in my chest
    <br />
    With every sideways glance
    <br />
    As I forget just for a moment that you're gone
    <br />
    I'm trying to hang on
    <br />
    <br />
    I'm weary of the bedroom now
    <br />
    Your final resting place
    <br />
    But I long for you to find me in my dreams
    <br />
    ...
    Close my eyes
    <br />
    Reliving every moment that we lost
    <br />
    Without you
    <br />
    I'm fading away but I'm trying to hang on
    <br />
    <br />
    No chance to say goodbye
    <br />A memorial's all we have left

...
export const LYRICS = (
  <>
    Take another pull of cheap whiskey and try to forget
    <br />
    ...
    <br />
    Float in the clouds of my chemical dependency
    <br />
    <br />
    ...
    <br />
    <br />
    No grasp of happiness, finding comfort in that it gets worse
    <br />
    Suspicious of anyone who comes close me
    <br />
    ...
    <br />
    <br />
    Desperate, hopeless struggle followed by a miserable death
    <br />
    Desperate, hopeless struggle followed by a miserable death
    <br />
    <br />
